...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Hello World web application."
  #
  #
  ...
  #
  # settings.secret_key_base= UVwKT7B4XQ06gGjFvHaPawkjexRWJSsv9oeC8xSQsKE
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("hello_world.log", "w"))
  #
  #
end
